...
namespace FutbolBack.Migrations
{
    ...
    [Migration("20241031171240_ajustes")]
            ...
            modelBuilder.Entity("FutbolBack.Modelos.Partido", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EquipoLocalId = 1,
                            EquipoVisitanteId = 2,
                            Fecha = new DateTime(2024, 10, 21, 14, 12, 38, 246, DateTimeKind.Local).AddTicks(4228)
                        },
                        new
                        {
                            Id = 2,
                            EquipoLocalId = 2,
                            EquipoVisitanteId = 1,
                            Fecha = new DateTime(2024, 10, 26, 14, 12, 38, 246, DateTimeKind.Local).AddTicks(4266)
                        });
                });
